...
public class Problem1534 {
    ...
    //Runtime: 19 ms, faster than 61.49% of Java online submissions for Count Good Triplets.
    //Memory Usage: 41.8 MB, less than 56.25% of Java online submissions for Count Good Triplets.
    static int countGoodTriplets1(int[] arr, int a, int b, int c) {
